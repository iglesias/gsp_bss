function [x_hat,h_hat,sv] = sparse_bci_nuclear(y,T,V,taux,tauh,varargin)
% SPARSE_BCI_NUCLEAR: Obtains the estimate of the filter and the elements 
% of a graph signal using the nuclear norm surrogate, assuming a sparse model for the signal
%
%
%           [x_hat,h_hat,sv] = sparse_bci_nuclear(y,T,L,taux,tauh,x_known,known_indexes)
